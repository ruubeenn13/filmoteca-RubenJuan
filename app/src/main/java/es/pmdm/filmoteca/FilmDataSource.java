...
public class FilmDataSource {
    ...
    private static void loadFilmsFromDatabase() {
        films.clear();
        ...
        if (cursor.moveToFirst()) {
            do {
                Film film = new Film();
                film.setId(cursor.getLong(cursor.getColumnIndexOrThrow("id")));
                ...
                film.setImbdURL(cursor.getString(cursor.getColumnIndexOrThrow("imdb_url")));
                film.setFormat(cursor.getInt(cursor.getColumnIndexOrThrow("format")));
                film.setGenre(cursor.getInt(cursor.getColumnIndexOrThrow("genre")));
                film.setComments(cursor.getString(cursor.getColumnIndexOrThrow("comments")));
                film.setImageResId(cursor.getInt(cursor.getColumnIndexOrThrow("image_res_id")));
                film.setFavorite(cursor.getInt(cursor.getColumnIndexOrThrow("is_favorite")) == 1);
